...
class ChatAiAndroidPage extends StatelessWidget {
  ChatAiAndroidPage({super.key});
              ...
              Row(
                children: [
                  ElevatedButton(
                    onPressed: () {
                      _install(
                          'https://firebasestorage.googleapis.com/v0/b/cupertino-studios-website.appspot.com/o/chatai-files%2Fapp-release.apk?alt=media&token=302e39cb-4e76-4035-857e-f82236517282'); // Replace with your download logic
                    },
...
Added share or delete chat options.
Added chat history backup options and auto backup.
