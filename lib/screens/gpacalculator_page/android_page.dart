...
class GPACalculatorAndroidPage extends StatelessWidget {
  GPACalculatorAndroidPage({super.key});
          ...
          child: Column(
            children: [
              ...
              const Row(
                children: [
                  AppIconWidget(
                    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/cupertino-studios-website.appspot.com/o/gpa-calculator-files%2Fgpa-calculator.png?alt=media&token=430c34d6-f8f6-48af-b423-e1ccb72729e8', // Replace with your app's icon URL
              ...
              Row(
                children: [
                  ElevatedButton(
                    onPressed: () {
                      _install('https://firebasestorage.googleapis.com/v0/b/cupertino-studios-website.appspot.com/o/gpa-calculator-files%2Fgpacalculator.apk?alt=media&token=6a1df79e-6114-4e6a-bfab-e9a22baa4555'); // Replace with your download logic
                    },
