...
class ImagenSupport extends StatelessWidget {
  final String email = 'cupertinostudios@gmail.com';
  final String phone = '+2348173227654';
  final String website = 'https://www.cupertinostudios.online';

  const ImagenSupport({super.key});
                  ...
                  Card(
                    child: Padding(
                      ...
                      child: Column(
                          children: <Widget>[
                            const Text(
                              'Welcome to Imagen App support page!',
                              style: TextStyle(
                                fontSize: 20,
