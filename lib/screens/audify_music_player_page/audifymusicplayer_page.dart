...
class AudifyMusicPlayerPage extends StatefulWidget {
  const AudifyMusicPlayerPage({super.key});

  @override
  State<AudifyMusicPlayerPage> createState() => _AudifyMusicPlayerPageState();
}

class _AudifyMusicPlayerPageState extends State<AudifyMusicPlayerPage> with SingleTickerProviderStateMixin {
                              ...
                              child: AnimatedContainer(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/cupertino-studios-website.appspot.com/o/audify-music-player-files%2Faudify.png?alt=media&token=ae77d914-55e2-4f3d-a129-280777621d93',
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            CupertinoButton(
                              onPressed: () => _launchURL('https://play.google.com/store/apps/details?id=com.music.audify'),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  ClipRRect(
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            CupertinoButton(
                              onPressed: () => _launchURL('https://appgallery.huawei.com/app/C108258673'),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  ClipRRect(
                  ...
                  children: [
                    ...
                    Card(
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: CachedNetworkImage(
                          imageUrl: 'https://firebasestorage.googleapis.com/v0/b/cupertino-studios-website.appspot.com/o/audify-music-player-files%2Faudify-feature.png?alt=media&token=e8a6501c-02c3-49f9-b5f2-02c2e98fe545',
                          placeholder: (context, url) =>
